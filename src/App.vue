...
[
    ...
    label: 'Boosty',
    btnClass: 'btn-boosty', //для этого задаешь ксс снизу как выглядеть будет кнопка
    ...
    currentColor: "currentColor" // заполнение цветом свг иконки, сейчас белый
  },
];
    ...
    <main v-else class="container p-4 desktop-layout">
      ...
      <section id="gallery" class="contglass p-4 mt-4 mb-4 ">
        ...
        <div class="masonry-gallery">
          ...
          <GalleryItem img="arts/art6.png"></GalleryItem>
          <GalleryItem img="arts/art8.png"></GalleryItem>
          <GalleryItem img="arts/art7.png"></GalleryItem>
