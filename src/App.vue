      ...
      <div class="social-row justify-content-center">
        <a class="social-btn btn-vk-depth" href="https://vk.com/ishwacha" aria-label="ВКонтакте">
          <svg width="24" height="24" viewBox="5.9 9.7 13.5 7.7" fill="currentColor">
            <path d="M12.6 17.4c-4.2 0-6.6-2.9-6.7-7.7h2.1c.1 3.5 1.6 5 2.8 5.3V9.7h2v3c1.2-.1 2.4-1.5 2.8-3h2c-.3 1.8-1.7 3.2-2.9 3.7 1.2.6 3 2 3.6 4h-2.2c-.5-1.5-1.8-2.7-3.3-2.9v2.9h-.2z"/>
          </svg>
          Вконтакте
        </a>
        <a class="social-btn btn-twitter" href="https://x.com/ishwacha" aria-label="Twitter">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            <path xmlns="http://www.w3.org/2000/svg" d="m21.742 21.75-7.563-11.179 7.056-8.321h-2.456l-5.691 6.714-4.54-6.714h-6.189l7.29 10.776-7.399 8.724h2.456l6.035-7.118 4.818 7.118h6.191zm-14.003-17.932 11.071 16.364h-2.447l-11.073-16.364h2.447z"/>
          </svg>
          Twitter
        </a>
  ...
  <main class="container contglass mt-3 p-4">
    ...
    <section id="gallery">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <small class="text-secondary" style="text-align: right; display: block;">{{ t('clickHint') }}</small>
      </div>

      <div class="row g-3">
        <GalleryItem img="/arts/art1.png" :title="t('art1')" />
        <GalleryItem img="/arts/art2.png" :title="t('art2')" />
        <GalleryItem img="/arts/art3.png" :title="t('art3')" />
        <GalleryItem img="/arts/art4.png" :title="t('art4')" />
      </div>
    </section>
    ...
    <div class="modal fade" id="modalImage" tabindex="-1" aria-hidden="true" data-bs-keyboard="true">
      <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0" style="background: rgba(10,10,15,0.6);">
          <div class="modal-body p-0">
            <button type="button" class="btn-close btn-close-white position-absolute top-0 end-0 m-3" data-bs-dismiss="modal" aria-label="Close"></button>
            <img src="" id="modalImg" class="w-100 rounded" />
            <div class="p-2 text-white small text-center" id="modalTitle"></div>
          </div>
        </div>
      </div>
    </div>
...
.social-row { display: flex; gap: .6rem; flex-wrap: wrap; align-items: center; }
.social-btn {
  display: inline-flex; align-items: center; gap: .6rem;
  padding: .5rem .9rem; border-radius: 30px; color: #fff; text-decoration: none;
  font-weight: 600; font-size: .95rem;
  min-width: 130px;
  transition: transform .16s ease, box-shadow .16s ease;
}
.social-btn svg { filter: drop-shadow(0 2px 6px rgba(0,0,0,0.25)); }
.social-btn:hover { transform: translateY(-2px); box-shadow: 0 14px 30px rgba(2,6,23,0.55); opacity: 0.98; }

.btn-telegram { background: linear-gradient(90deg,#2AABEE,#1E8ED8); }
.btn-twitter { background: linear-gradient(60deg,#000000,#202020); }
.btn-reddit { background: linear-gradient(90deg,#FF4500,#FF6A00); }
.btn-steam { background: linear-gradient(90deg,#171A21,#0b0c0f); }

.avatar {
  width: 140px; height: 140px;
  border-radius: 50%;
  object-fit: cover; border: 4px solid rgba(20,20,20, 0.9);
...
@media (max-width: 576px) {
  ...
  #gallery .row { --bs-gutter-y: 0.5rem; }
  .gallery-img { height: 150px; }
  .card-glass { font-size: 0.8rem; padding: 0.75rem; }
  .mod-card { padding: 0.75rem; }
  .mod-card h3.h6 { font-size: 1rem; }
  .mod-card .btn-sm { padding: 0.25rem 0.5rem; font-size: 0.8rem; }
...
@media (min-width: 577px) and (max-width: 768px) {
  ...
  .social-btn { font-size: 0.85rem; padding: 0.4rem 0.7rem; }
